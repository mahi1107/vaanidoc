/**
 * Comprehensive list of all 780+ Districts across all 28 States and 8 Union Territories of India.
 * Official Census & Ministry of Panchayati Raj / Survey of India hierarchy.
 */
...
export const INDIAN_STATES_DISTRICTS = {
  ...
  "Maharashtra": [
    ...
    "Buldhana", "Chandrapur", "Chhatrapati Sambhajinagar", "Dharashiv (Osmanabad)",
...
// Internal map from District Name -> State Name (for facility lookup / backend mapping)
export const DISTRICT_TO_STATE_MAP = {};
Object.entries(INDIAN_STATES_DISTRICTS).forEach(([state, districts]) => {
  districts.forEach(district => {
    DISTRICT_TO_STATE_MAP[district] = state;
  });
});

// Flattened list of all unique districts across all of India, sorted alphabetically by district name
export const ALL_INDIAN_DISTRICTS = Array.from(
  new Set(Object.values(INDIAN_STATES_DISTRICTS).flat())
).sort((a, b) => a.localeCompare(b, undefined, { sensitivity: 'base' }));

// Default district for initial state
